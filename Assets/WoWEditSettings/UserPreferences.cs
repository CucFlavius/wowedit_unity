...
public static class UserPreferences
{
    public static void Load()
    {
        try
        {
            ...
            Settings.showVertexColor = (PlayerPrefs.GetInt("Settings.showVertexColor") == 1) ? true : false;
    ...
    public static void Save()
    {
        ...
        PlayerPrefs.SetInt("Settings.showVertexColor", Settings.showVertexColor ? 1 : 0);
