...
namespace Assets.Data.WoW_Format_Parsers.WMO
{
    ...
    {
        public static Queue<WMOStruct> AllWMOData = new Queue<WMOStruct>();
        public static WMOStruct wmoData = new WMOStruct();
    ...
    public struct StaticLight
    {
        public LightType type;
        public byte useAttenuation;
        public byte useUnknown1;
        public byte useUnknown2;
        public BGRA color;
        public Vector3 position;
    ...
    public struct DoodadInstanceFlags
    {
    ...
    public struct DoodadInstanceInfo
    {
