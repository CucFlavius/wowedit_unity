...
public static partial class DB2
{
    public static class DBDBuild
    {
        public class Build : IComparable
        {
            ...
            {
                if (build > 0xFFFFF) Debug.Log("Build too large for fake hash code");
                if (minor > 0xF) Debug.Log("Minor too large for fake hash code");
                if (major > 0xF) Debug.Log("Major too large for fake hash code");
                if (expansion > 0xF) Debug.Log("Expansion too large for fake hash code");
